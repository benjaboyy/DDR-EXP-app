            ...
            if($rowCount <= 0) {
                ...
                if($is_active == '1') {
                    if($email_signin == $email && $password_signin == $password) {
                       ...
                       $_SESSION['night_visits']   = $night_visits;
                       $_SESSION['date_time']      = $date_time;
                        
                       $_SESSION['iidx']           = $iidx_scores;
                       $_SESSION['popn']           = $popn_scores;
                       $_SESSION['itg']            = $itg_scores;
                       $_SESSION['itg_d']          = $itg_d_scores;
                       $_SESSION['pump']           = $pump_scores;
                       $_SESSION['pump_d']         = $pump_d_scores;
